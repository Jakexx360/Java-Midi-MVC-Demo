...
/**
 * Mock MidiDevice Synthesizer
 */
public class MockSynth implements Synthesizer {

    private final StringBuilder sb;

    public MockSynth(StringBuilder sb) {
        this.sb = sb;
    }
    ...
    @Override
    public boolean remapInstrument(Instrument instrument, Instrument instrument1) {
        return false;
    }
